...
import { Disclosure, Menu } from '@headlessui/vue'
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="-mr-2 flex md:hidden">
            <Disclosure.Button class="inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
          ...
          <div class="mt-3 space-y-1 px-2">
            <Disclosure.Button v-for="item in userNavigation" :key="item.name" as="a" :href="item.href" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">{{ item.name }}</Disclosure.Button>
          </div>
        </div>
      </DisclosurePanel>
    </Disclosure>
